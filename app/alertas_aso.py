...
def montar_corpo_email(criticos: list[dict]) -> str:
    ...
    <div style="font-family: Arial, sans-serif; color: #222;">
      ...
      <p style="color:#888;font-size:12px;margin-top:20px;">E-mail automatico do sistema Operacoes SolarSync.</p>
    </div>
    """
...
def verificar_e_enviar_alertas(db: Session) -> dict:
    ...
    assunto = f"[Operacoes SolarSync] {len(criticos)} ASO(s) vencido(s) ou vencendo em breve"
